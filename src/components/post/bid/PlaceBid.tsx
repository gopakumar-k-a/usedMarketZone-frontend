...
function PlaceBid({ pId ,highestBid,basePrice}:{pId:string,highestBid:string,basePrice:string}) {
        ...
        <div className="min-h-48 w-full">
          <div className="col-span-2  w-full flex">
            <h1 className="font-bold  text-lg w-full h-full flex items-center justify-start">
              highest bid- <span className="font-bold  text-lg text-red-500" >{highestBid?highestBid:'no bids placed'}</span>
            </h1>
          </div>
