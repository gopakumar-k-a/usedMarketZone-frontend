        ...
        <>
            ...
            <section className="flex items-center justify-center px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-8">
                <div className="xl:mx-auto xl:w-full shadow-md p-4 xl:max-w-sm 2xl:max-w-md">
                    <h2 className="text-left text-2xl font-bold leading-tight text-black">Sign Up</h2>
                                ...
                                <div className="space-y-5">
                                    <div className="relative">
                                        <label className="text-base font-medium text-gray-900">
                                            <p className="text-left text-sm font-semibold text-black">First Name</p>
                                        </label>
                                        <div className="mt-2">
                                            <div className="relative">
                                                ...
                                                />
                                                <ErrorMessage name="firstName" component="div" className="absolute text-red-500 text-sm mt-1" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="relative">
                                        <label className="text-base font-medium text-gray-900">
                                            <p className="text-left text-sm font-semibold text-black">Last Name</p>
                                        </label>
                                        <div className="mt-2">
                                            <div className="relative">
                                                <div className="absolute inset-y-0 left-0 flex items-center pl-3">
                                                ...
                                                <Field
                                                    ...
                                                    className="pl-8 pr-3 flex h-10 w-full rounded-md border border-gray-300 bg-transparent px-3 py-2 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
                                                />
                                                <ErrorMessage name="lastName" component="div" className="absolute text-red-500 text-sm mt-1" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="relative">
                                        <label className="text-base font-medium text-gray-900">
                                            <p className="text-left text-sm font-semibold text-black">Email</p>
                                        </label>
                                        <div className="mt-2">
                                            <div className="relative">
                                                <div className="absolute inset-y-0 left-0 flex items-center pl-3">
                                                ...
                                                <Field
                                                    ...
                                                    className="pl-8 pr-3 flex h-10 w-full rounded-md border border-gray-300 bg-transparent px-3 py-2 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
                                                />
                                                <ErrorMessage name="email" component="div" className="absolute text-red-500 text-sm mt-1" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="relative">
                                        <label className="text-base font-medium text-gray-900">
                                            <p className="text-left text-sm font-semibold text-black">Phone</p>
                                        </label>
                                        <div className="mt-2">
                                            <div className="relative">
                                                <div className="absolute inset-y-0 left-0 flex items-center pl-3">
                                                ...
                                                <Field
                                                    ...
                                                    className="pl-8 pr-3 flex h-10 w-full rounded-md border border-gray-300 bg-transparent px-3 py-2 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
                                                />
                                                <ErrorMessage name="phone" component="div" className="absolute text-red-500 text-sm mt-1" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="relative">
                                        <p className="text-left text-sm font-semibold text-black">Password</p>
                                        <div className="relative mt-2">
                                            ...
                                            <ErrorMessage name="password" component="div" className="absolute text-red-500 text-sm mt-1" />
                                        </div>
                                    </div>
                                    <div className="relative">
                                        <p className="text-left text-sm font-semibold text-black">Confirm Password</p>
                                        <div className="relative mt-2">
                                            <div className="absolute inset-y-0 left-0 flex items-center pl-3">
                                                <FontAwesomeIcon icon={faLock} className="h-5 w-5 text-gray-400" />
                                            </div>
                                            ...
                                            <ErrorMessage name="confirmPassword" component="div" className="absolute text-red-500 text-sm mt-1" />
                                        </div>
                                    </div>
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex items-center justify-between">
                                            <label className="text-base font-medium text-gray-900">
                                                <p className="text-sm font-semibold text-black">Forgot Password?</p>
                                            </label>
                                            <Link to="/forgot-password" className="text-sm font-semibold text-blue-500 hover:underline">
                                                Forgot Password
                                            </Link>
                                        </div>
                                        <div>
