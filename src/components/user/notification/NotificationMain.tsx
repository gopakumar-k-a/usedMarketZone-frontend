...
function NotificationMain() {
  ...
  const notificationStatusChangeApi = async () => {
    await changeNotificationUnreadStatus().then(() => {
  ...
  return (
    <>
      <div
        className="w-full z-10  h-full overflow-x-hidden transform  transition ease-in-out duration-700"
        id="notification"
      >
        <div className="w-full bg-gray-50 h-screen overflow-y-auto p-8 absolute right-0">
          ...
          <div className="w-full p-3 mt-4 bg-red-100 rounded flex items-center">
            ...
            <div className="pl-3 w-full flex items-center justify-between">
              <p className="focus:outline-none text-sm leading-none text-red-700">
                Low on storage: 2.5/32gb remaining
              </p>
              <p className="focus:outline-none text-xs leading-3 cursor-pointer underline text-right text-red-700">
                Manage
              </p>
            </div>
          </div>
          ...
          <div className="w-full p-3 mt-8 bg-green-100 rounded flex items-center">
            ...
            <div className="pl-3 w-full">
              <div className="flex items-center justify-between">
                <p className="focus:outline-none text-sm leading-none text-green-700">
                  Design sprint completed
                </p>
                <p className="focus:outline-none focus:text-indigo-600 text-xs leading-3 underline cursor-pointer text-green-700">
                  View
                </p>
              </div>
            </div>
