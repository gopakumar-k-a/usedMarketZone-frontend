...
function FollowingNotification({userName,createdAt}:{userName:string,createdAt:string}) {
  return (
    <>
      <div className="sm:w-8/12 p-3 mt-4 bg-white rounded flex">
        ...
        <div className="pl-3">
          <p className="focus:outline-none text-sm leading-none">
            <span className="text-indigo-700 cursor-pointer">{userName && userName}</span> Started Following
            You
          </p>
