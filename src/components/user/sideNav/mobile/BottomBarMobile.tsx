    ...
    <nav className="bg-gray-800 p-4 flex justify-around h-full">
      ...
      {isListVisible && (
        <ul className="absolute bottom-full mb-2 bg-white border border-gray-300 rounded shadow-lg w-48">
          ...
          <li className={`flex items-center px-4 py-2 hover:bg-gray-300 ${currentPath == "/post/sell-product" ? "bg-gray-200":""}  text-black`}>
            <FaHandHolding className="mr-2" /> sell product
          </li>
          </Link>
          <Link to={"/post/auction-product"} onClick={toggleListVisibility}>
          
          <li className={`flex items-center px-4 py-2 hover:bg-gray-300 ${currentPath == "/post/auction-product" ? "bg-gray-200":""}  text-black`}>
          <ImHammer2/> auction product</li>
          </Link>
        ...
        currentPath == "/post/auction-product" ? (
          <AiFillPlusCircle className="w-5 h-5" onClick={toggleListVisibility}/>
        ) : (
          <AiOutlinePlusCircle className="w-5 h-5" onClick={toggleListVisibility}/>
        )}
      </div>
